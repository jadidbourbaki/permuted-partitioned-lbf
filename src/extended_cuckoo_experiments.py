...
def run_extended_cuckoo_experiments():
    ...
    memory_budgets = [52424, 104856, 262144, 524288, 1048576, 2097152, 4194304, 8388608]  # in bytes
    ...
    # Save to CSV
    with open("bin/extended_cuckoo_experiment_results.csv", "w", newline='') as csvfile:
    ...
    print("Saved extended cuckoo experiment results to bin/extended_cuckoo_experiment_results.csv")

if __name__ == '__main__':
    run_extended_cuckoo_experiments()
